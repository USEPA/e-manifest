...
The e-Manifest system provides a set of services that can be used by industry and regulators.
The services are available via a RESTful API, and are categorized by the type of user that can access them and the resource.
